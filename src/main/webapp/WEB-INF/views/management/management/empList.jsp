                ...
                <div class="row align-items-center" style="margin-top:20px;">
                    ...
                    <div class="col-3">
                        <div class="text-center mb-n4">
                            <img src="${pageContext.request.contextPath}/resources/assets/images/logos/symbol-01.png"
                                alt="modernize-img" class="img-fluid" style="width: 120px; height: auto;">
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="ms-auto">
                                            <span class="text-primary display-6">
                                                <span class="badge bg-primary-subtle text-primary"
                                                    style="font-size: 1rem; padding: 0.5rem 0.5rem;">승인</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ms-auto">
                                            <span class="text-success display-6">
                                                <span class="badge bg-success-subtle text-success"
                                                    style="font-size: 1rem; padding: 0.5rem 0.5rem;">승인대기</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ms-auto">
                                            <span class="text-danger display-6">
                                                <span class="badge bg-danger-subtle text-danger"
                                                    style="font-size: 1rem; padding: 0.5rem 0.5rem;">반려</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ms-auto">
                                            <span class="text-warning display-6">
                                                <span class="badge text-bg-light"
                                                    style="color: gray !important; font-size: 1rem; padding: 0.5rem 0.5rem;">퇴사</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 d-flex justify-content-end align-items-center ms-auto">
                        <form action="/management/list" method="get" class="w-90 d-flex" id="searchForm">
                            ...
                            <div class="input-group position-relative">
                                <input type="text" class="form-control product-search ps-5 pe-5" id="input-search"
                                    name="searchWord" placeholder="Search Contacts..." value="${searchWord}" />
                ...
                <div class="card card-body">
                                        ...
                                        <c:otherwise>
                                            <c:forEach items="${pagingVO.dataList}" var="emp">
                                                <tr class="search-items"
                                                    onclick="location.href='/management/empDetail?empId=${emp.empId}';"
                                                    style="cursor: pointer;">
                                                    <td>
                                                        <div class="d-flex align-items-center" style="margin-left: 30%;">
                                                            <img src="${emp.empImage}" alt="avatar"
                                                    ...
                                                    <td>
                                                        <span
                                                            class="usr-empStartdate">${fn:split(emp.empStartdate, " ")[0]}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${emp.empApproval == 'Y'}">
                                                                <span class="badge bg-primary-subtle text-primary"
                                                                    data-emplNo="승인여부">승인</span>
                                                            </c:when>
                                                            <c:when test="${emp.empApproval == 'R'}">
                                                                <span class="badge bg-danger-subtle text-danger"
                                                                    data-emplNo="승인여부">반려</span>
                                                            </c:when>
                                                            <c:when test="${emp.empApproval == 'N'}">
                                                                <span class="badge bg-success-subtle text-success"
                                                                    data-emplNo="승인여부">승인대기</span>
                                                            </c:when>
                                                            <c:when test="${emp.empDel == 'Y'}">
                                                                <span class="badge text-bg-light"
                                                                    style="color: gray !important;"
                                                                    data-emplNo="승인여부">퇴사</span>
                                                            </c:when>
                                                        </c:choose>
                                                    </td>
                                                    <td>
                                                        <div class="action-btn">
                                                            <a href="/management/empDetail?empId=${emp.empId}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="/management/registerForm" id="btn-add-contact"
