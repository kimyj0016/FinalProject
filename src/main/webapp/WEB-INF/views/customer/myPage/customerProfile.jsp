			                                    ...
			                                    <div class="d-flex align-items-center gap-3">
			                                        ...
			                                        <div>
			                                            ...
			                                            <c:if test="${myHotelVO.htNo == '1'}">
			                                                <h5 class="fs-4 fw-semibold me-2">싱글룸(101~105)</h5>
			                                            </c:if>
			                                            <c:if test="${myHotelVO.htNo == '2'}">
			                                                <h5 class="fs-4 fw-semibold me-2">싱글룸(201~205)</h5>
			                                            </c:if>
			                                            <c:if test="${myHotelVO.htNo == '3'}">
			                                                <h5 class="fs-4 fw-semibold me-2">싱글룸(301~305)</h5>
			                                            </c:if>
			                                            <c:if test="${myHotelVO.htNo == '4'}">
			                                                <h5 class="fs-4 fw-semibold me-2">싱글룸(401~405)</h5>
			                                            </c:if>
			                                            <c:if test="${myHotelVO.htNo == '5'}">
			                                                <h5 class="fs-4 fw-semibold me-2">싱글룸(501~505)</h5>
			                                            </c:if>
			                                        </div>
			                                        <div>
			                                            <p class="mb-0">체크인</p>
			                                    ...
			                                    <div class="d-flex align-items-center gap-3">
			                                        ...
			                                        <div>
			                                            ...
			                                            <c:if test="${myRoungeVO.rgNo == '7'}">
			                                                <h5 class="fs-4 fw-semibold me-2">더 라운지</h5>
			                                            </c:if>
			                                            <c:if test="${myRoungeVO.rgNo == '8'}">
			                                                <h5 class="fs-4 fw-semibold me-2">마티나 라운지</h5>
			                                            </c:if>
			                                            <c:if test="${myRoungeVO.rgNo == '9'}">
			                                                <h5 class="fs-4 fw-semibold me-2">스카이허브 라운지</h5>
			                                            </c:if>
			                                        </div>
			                                        <div>
