...
<!--                 <div class="controls"> -->
<%--                     <c:forEach begin="0" step="1" end="${planeVO[0].seat.size() - 1}" var="i"> --%>
<%--                         <input type="text" name="tkVO[${i }].tkEngfirst" class="form-control tkVO${i }" value="" required data-validation-required-message="This field is required" /> --%>
<%--                     </c:forEach> --%>
<!--                 </div> -->
<!--             </div> -->
<!--             <div class="mb-3 form-group col-3"> -->
...
<!--                 <div class="controls"> -->
<%--                     <c:forEach begin="0" step="1" end="${planeVO[0].seat.size() - 1}" var="i"> --%>
<%--                         <input type="text" name="tkVO[${i }].tkLastname" class="form-control tkVO${i }" required data-validation-required-message="This field is required" /> --%>
<%--                     </c:forEach> --%>
<!--                 </div> -->
<!--             </div> -->
<!--             <div class="mb-3 form-group col-3"> -->
...
<!--                 <div class="controls"> -->
<%--                     <c:forEach begin="0" step="1" end="${planeVO[0].seat.size() - 1}" var="i"> --%>
<%--                         <input type="text" name="tkVO[${i }].tkPassport" class="form-control tkVO${i }" required data-validation-required-message="This field is required" /> --%>
<%--                     </c:forEach> --%>
<!--                 </div> -->
<!--             </div> -->
<!--             <div class="mb-3 form-group col-3"> -->
...
<!--                 <div class="controls"> -->
<%--                     <c:forEach begin="0" step="1" end="${planeVO[0].seat.size() - 1}" var="i"> --%>
<%--                         <input type="text" name="tkVO[${i }].tkTel" class="form-control tkVO${i }" required data-validation-required-message="This field is required" /> --%>
<%--                     </c:forEach> --%>
<!--                 </div> -->
<!--             </div> -->
<!--             <div class="mb-3 form-group col-3"> -->
...
<!--                 <div class="controls"> -->
<%--                     <c:forEach begin="0" step="1" end="${planeVO[0].seat.size() - 1}" var="i"> --%>
<%--                         <input type="text" name="tkVO[${i }].tkEmail" class="form-control tkVO${i }" required data-validation-required-message="This field is required" /> --%>
<%--                     </c:forEach> --%>
<!--                 </div> -->
<!--             </div> -->
<!--             <div id="ticketPrice"><span id="tkV">100</span>원</div> -->
<!--             <span class="hiding"> -->
<%--                 <c:forEach var="i" begin="0" end="${pVO.size() - 1 }" step="1"> --%>
<%--                     <c:forEach begin="0" step="1" end="${planeVO[0].seat.size() - 1}" var="j"> --%>
<%--                         <input type="text" name="tkVO[${j }].tkFlight" value="${pVO[i].scNo }" /> --%>
...
<!--                     결제 -->
<!--                 </button> -->
<!--                 <button type="button" class="btn bg-danger-subtle text-danger mainBtn"> -->
<!--                     홈 -->
<!--                 </button> -->
<!--                 <button type="button" class="btn btn-primary testVal"> -->
<!--                     더미데이터 -->
...
$(function(){
	...
	console.log('planeVO :: ' + "${planeVO}");
	console.log('pVO :: ' + "${pVO}");
	console.log("${planeVO[0].cusCnt}");
	console.log("${planeVO[0].seat}");
